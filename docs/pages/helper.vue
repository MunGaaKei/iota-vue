<template>
  ...
  <p>
    使用方式：<code>.[type]-[n]</code>，如<code> .pd-12</code> 表示内边距<code
      >padding: 12px</code
    >。
  </p>
  ...
  <i-list class="my-20" label-width="180px" style="font-family: monospace">
...
import { iList, iListItem } from "@p/components";
